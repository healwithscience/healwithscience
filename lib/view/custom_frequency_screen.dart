...
class _CustomFrequencyScreenState extends State<CustomFrequencyScreen> {
  ...
  void showFrequencyDialog(BuildContext context, CustomFrequencyController value, String programName) {
    showDialog(
  ...
  void showAddProgramDialog(BuildContext context, CustomFrequencyController value) {
    showDialog(
      barrierDismissible: false,
      context: context,
      builder: (BuildContext context) {
