...
class PaidFrequencyScreen extends StatefulWidget {
  const PaidFrequencyScreen({super.key});

  @override
  State<PaidFrequencyScreen> createState() => _PaidFrequencyScreenState();
}

class _PaidFrequencyScreenState extends State<PaidFrequencyScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<PaidFrequencyController>(builder: (value) {
