                              ...
                              children: [
                                Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child:
                                        SvgPicture.asset(AssetPath.back_arrow),
                                  ),
                                ),
                                CommonTextWidget(
                                    lineHeight: 1.3,
                              ...
                              child: Container(
                                ...
                                child: StaggeredGridView.countBuilder(
                                  ...
                                  itemBuilder:
                                    ...
                                    child: InkWell(
                                      onTap: () {
                                        if (index == 0) {
                                          Get.toNamed(
                                              AppRouter.getCategoryScreen());
                                        } else if (index == 2) {
                                          Get.toNamed(
                                              AppRouter.getFrequencyScreen());
                                        } else if (index == 4) {
                                          Get.toNamed(
                                              AppRouter.getPlaylistScreen());
                                        } else if (index == 3) {
                                          Get.toNamed(
                                              AppRouter.getHeartScreen());
                                        } else if (index == 1) {
                                          Get.toNamed(AppRouter
                                              .getCustomFrequencyScreen());
                                        }
                                      },
                                      child: Card(
                                  ...
                                  staggeredTileBuilder: (int index) =>
                                      StaggeredTile.count(index == 0 ? 4 : 2,
                                          index.isOdd ? 3 : 2),
